...
4. **Configure your MCP client**
   ...
   Add the following configuration to your MCP client (e.g., Cursor, VSCode) and replace `/path/to/your-repo/dist/index.js` with the actual path to your built server.
